...
import '../css/TravelCard2.css'; // Import the CSS file
...
const TravelCards = ({ heading }) => {
  const cardsData = [
    ...
    { imgSrc: 'https://media1.thrillophilia.com/filestore/o5mthnirc88oqt0urede9xfr6nwk_shutterstock_2414542203.jpg?w=340&dpr=2', country: 'Switzerland', price: '31,508', bestTime: 'May-Sep' },
    ...
    { imgSrc: 'https://media1.thrillophilia.com/filestore/91auwe9632in9yhrixuqzuznmolq_1556193320_marina2.jpg?w=240&dpr=2', country: 'Germany', price: '10,298', bestTime: 'May-Sep' },
  ];
